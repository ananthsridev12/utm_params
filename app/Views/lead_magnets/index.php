<div class="page-header">
  <div>
    <h1><?= e($title) ?>s</h1>
    <p class="subtitle">Gated assets/tools offered on landing pages (e.g. CPQ Readiness Assessment).</p>
  </div>
  <div>
...
<div class="card">
  ...
  <?php else: ?>
  <table>
    <thead><tr><th>Name</th><th>Slug</th><th>Vertical</th><th>Service</th><th>Status</th><th></th></tr></thead>
    <tbody>
