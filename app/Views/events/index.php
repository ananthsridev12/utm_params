<div class="page-header">
  <div>
    <h1><?= e($title) ?>s</h1>
    <p class="subtitle">Tracking events fired to GA4/dataLayer on form submission (e.g. lead_submitted).</p>
  </div>
  <div>
...
<div class="card">
  ...
  <?php else: ?>
  <table>
    <thead><tr><th>Event name (GA4)</th><th>Description</th><th>Status</th><th></th></tr></thead>
    <tbody>
