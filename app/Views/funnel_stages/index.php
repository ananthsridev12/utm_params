<div class="page-header">
  <div>
    <h1><?= e($title) ?>s</h1>
    <p class="subtitle">Funnel stages leads pass through (e.g. Awareness, Interest, Capture, MQL, SQL, Convert).</p>
  </div>
  <div>
...
<div class="card">
  ...
  <?php else: ?>
  <table>
    <thead><tr><th>Sort</th><th>Name</th><th>Description</th><th>Status</th><th></th></tr></thead>
    <tbody>
