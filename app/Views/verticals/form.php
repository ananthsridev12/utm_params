...
<div class="card" style="max-width:640px">
  <form method="post" action="<?= $mode === 'create' ? url($routeBase . '/create') : url($routeBase . '/edit/' . $record['id']) ?>">
    ...
    <div class="field">
      ...
      <input type="text" id="short_code" name="short_code" value="<?= e($record['short_code'] ?? '') ?>" placeholder="e.g. DT" required>
      <div class="hint">Used inside generated form_id slugs. Letters/numbers only, e.g. DT, GL.</div>
